            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                        ...
                        <table class="shop_table cart">
                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-thumbnail">
                                    ...
                                    <div class="cart-product__item">
                                        ...
                                        <div class="cart-product-content">
                                            <p class="cart-author">{{$item->name}}</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="product-quantity">
                                    ...
                                    <div class="quantity">
                                    <a href="{{route('cart.dcr',['id'=>$item->rowId,'qty'=>$item->qty])}}" class="quantity-minus"> -</a>
                                    <input title="Qty" class="email input-text qty text" type="text" value="{{$item->qty}}" readonly>
                                        <a href="{{route('cart.incr',['id'=>$item->rowId,'qty'=>$item->qty])}}" class="quantity-plus">+</a>
                                    </div>
                    ...
                    <div class="cart-total">
                        ...
                        <a href="{{route('checkout.index')}}" class="btn btn-medium btn--light-green btn-hover-shadow">
